  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="flex gap-2 px-4 py-3 overflow-x-auto border-b border-gray-200 bg-white">
        ...
        <Link href="/admin/ratings" className="px-3 py-1.5 rounded-full text-sm font-medium bg-gray-100 text-zinc-700 whitespace-nowrap">
          דירוגים
        </Link>
        <Link href="/admin/technical" className="px-3 py-1.5 rounded-full text-sm font-medium bg-gray-100 text-zinc-700 whitespace-nowrap">
          טכני
        </Link>
      </nav>
